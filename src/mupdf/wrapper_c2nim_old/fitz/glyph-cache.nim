...
# import
#   mupdf/fitz/context, mupdf/fitz/geometry, mupdf/fitz/font, mupdf/fitz/pixmap,
#   mupdf/fitz/device
...
proc fzPurgeGlyphCache*(ctx: ptr FzContext) {.cdecl, importc: "fz_purge_glyph_cache",
    header: "glyph-cache.h".}
## *
...
proc fzRenderGlyphPixmap*(ctx: ptr FzContext; font: ptr FzFont; gid: cint;
                         ctm: ptr FzMatrix; scissor: ptr FzIrect; aa: cint): ptr FzPixmap {.
    cdecl, importc: "fz_render_glyph_pixmap", header: "glyph-cache.h".}
## *
...
proc fzRenderT3GlyphDirect*(ctx: ptr FzContext; dev: ptr FzDevice; font: ptr FzFont;
                           gid: cint; trm: FzMatrix; gstate: pointer;
                           defCs: ptr FzDefaultColorspaces) {.cdecl,
    importc: "fz_render_t3_glyph_direct", header: "glyph-cache.h".}
## *
...
proc fzPrepareT3Glyph*(ctx: ptr FzContext; font: ptr FzFont; gid: cint) {.cdecl,
    importc: "fz_prepare_t3_glyph", header: "glyph-cache.h".}
## *
## 	Dump debug statistics for the glyph cache.
##

proc fzDumpGlyphCacheStats*(ctx: ptr FzContext; `out`: ptr FzOutput) {.cdecl,
    importc: "fz_dump_glyph_cache_stats", header: "glyph-cache.h".}
## *
...
proc fzSubpixelAdjust*(ctx: ptr FzContext; ctm: ptr FzMatrix; subpixCtm: ptr FzMatrix;
                      qe: ptr cuchar; qf: ptr cuchar): cfloat {.cdecl,
    importc: "fz_subpixel_adjust", header: "glyph-cache.h".}