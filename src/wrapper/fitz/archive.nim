...
proc fzOpenArchive*(ctx: ptr FzContext; filename: cstring): ptr FzArchive {.cdecl,
...
proc fzOpenArchiveWithStream*(ctx: ptr FzContext; file: ptr FzStream): ptr FzArchive {.
    cdecl, importc: "fz_open_archive_with_stream", header: "archive.h".}
## *
...
proc fzOpenDirectory*(ctx: ptr FzContext; path: cstring): ptr FzArchive {.cdecl,
    importc: "fz_open_directory", header: "archive.h".}
## *
## 	Determine if a given path is a directory.
##

proc fzIsDirectory*(ctx: ptr FzContext; path: cstring): cint {.cdecl,
...
proc fzDropArchive*(ctx: ptr FzContext; arch: ptr FzArchive) {.cdecl,
    importc: "fz_drop_archive", header: "archive.h".}
## *
## 	Keep a reference to an archive.
##

proc fzKeepArchive*(ctx: ptr FzContext; arch: ptr FzArchive): ptr FzArchive {.cdecl,
...
proc fzArchiveFormat*(ctx: ptr FzContext; arch: ptr FzArchive): cstring {.cdecl,
...
proc fzCountArchiveEntries*(ctx: ptr FzContext; arch: ptr FzArchive): cint {.cdecl,
...
proc fzListArchiveEntry*(ctx: ptr FzContext; arch: ptr FzArchive; idx: cint): cstring {.
    cdecl, importc: "fz_list_archive_entry", header: "archive.h".}
## *
...
proc fzHasArchiveEntry*(ctx: ptr FzContext; arch: ptr FzArchive; name: cstring): cint {.
    cdecl, importc: "fz_has_archive_entry", header: "archive.h".}
## *
...
proc fzOpenArchiveEntry*(ctx: ptr FzContext; arch: ptr FzArchive; name: cstring): ptr FzStream {.
    cdecl, importc: "fz_open_archive_entry", header: "archive.h".}
## *
...
proc fzReadArchiveEntry*(ctx: ptr FzContext; arch: ptr FzArchive; name: cstring): ptr FzBuffer {.
    cdecl, importc: "fz_read_archive_entry", header: "archive.h".}
## *
...
proc fzIsTarArchive*(ctx: ptr FzContext; file: ptr FzStream): cint {.cdecl,
...
proc fzOpenTarArchive*(ctx: ptr FzContext; filename: cstring): ptr FzArchive {.cdecl,
...
proc fzOpenTarArchiveWithStream*(ctx: ptr FzContext; file: ptr FzStream): ptr FzArchive {.
    cdecl, importc: "fz_open_tar_archive_with_stream", header: "archive.h".}
## *
...
proc fzIsZipArchive*(ctx: ptr FzContext; file: ptr FzStream): cint {.cdecl,
...
proc fzOpenZipArchive*(ctx: ptr FzContext; path: cstring): ptr FzArchive {.cdecl,
...
proc fzOpenZipArchiveWithStream*(ctx: ptr FzContext; file: ptr FzStream): ptr FzArchive {.
    cdecl, importc: "fz_open_zip_archive_with_stream", header: "archive.h".}
## *
...
proc fzNewZipWriter*(ctx: ptr FzContext; filename: cstring): ptr FzZipWriter {.cdecl,
...
proc fzNewZipWriterWithOutput*(ctx: ptr FzContext; `out`: ptr FzOutput): ptr FzZipWriter {.
    cdecl, importc: "fz_new_zip_writer_with_output", header: "archive.h".}
## *
...
proc fzWriteZipEntry*(ctx: ptr FzContext; zip: ptr FzZipWriter; name: cstring;
                     buf: ptr FzBuffer; compress: cint) {.cdecl,
...
proc fzCloseZipWriter*(ctx: ptr FzContext; zip: ptr FzZipWriter) {.cdecl,
...
proc fzDropZipWriter*(ctx: ptr FzContext; zip: ptr FzZipWriter) {.cdecl,
...
proc fzNewTreeArchive*(ctx: ptr FzContext; tree: ptr FzTree): ptr FzArchive {.cdecl,
...
proc fzNewMultiArchive*(ctx: ptr FzContext): ptr FzArchive {.cdecl,
...
proc fzMountMultiArchive*(ctx: ptr FzContext; arch: ptr FzArchive; sub: ptr FzArchive;
                         path: cstring) {.cdecl, importc: "fz_mount_multi_archive",
                                        header: "archive.h".}
## *
...
proc fzNewArchiveOfSize*(ctx: ptr FzContext; file: ptr FzStream; size: cint): ptr FzArchive {.
    cdecl, importc: "fz_new_archive_of_size", header: "archive.h".}
