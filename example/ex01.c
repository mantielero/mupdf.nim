...
gcc -g -o ex01  ex01.c /usr/lib/libmupdf.a  /usr/lib/libmupdf-third.a -lfreetype -lmujs -lopenjpeg -ljbig2dec -lopenjp2  -ljpeg -lz -lm -lgumbo -lharfbuzz
./ex01 helloworld.pdf 1 100 0 > salida.ppm
